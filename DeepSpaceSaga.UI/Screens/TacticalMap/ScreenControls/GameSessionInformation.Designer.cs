namespace DeepSpaceSaga.UI.Screens.TacticalMap.ScreenControls
{
    partial class GameSessionInformation
    {
        ...
        private void InitializeComponent()
        {
            ...
            // crlCloseButton
            // 
            crlCloseButton.Location = new Point(341, 9);
            // 
            // label1
            // 
            ...
            txtTurn.Location = new Point(164, 66);
            txtTurn.Margin = new Padding(4, 0, 4, 0);
            txtTurn.Name = "txtTurn";
            txtTurn.Size = new Size(192, 25);
            txtTurn.TabIndex = 1;
            txtTurn.Text = "0";
            // 
            // crlGameCoordinates
            ...
            txtCelestialObjects.Location = new Point(164, 116);
            txtCelestialObjects.Margin = new Padding(4, 0, 4, 0);
            txtCelestialObjects.Name = "txtCelestialObjects";
            txtCelestialObjects.Size = new Size(152, 25);
            ...
            txtSpeed.Location = new Point(164, 91);
            txtSpeed.Margin = new Padding(4, 0, 4, 0);
            txtSpeed.Name = "txtSpeed";
            txtSpeed.Size = new Size(152, 25);
            txtSpeed.TabIndex = 6;
            txtSpeed.Text = "0";
            // 
            // label4
